...
st.image(img,width=600,caption='Important: After Your Technical & Fundumental Analysis look our Predict')

with st.sidebar:
    selected = option_menu("Guide", ["Automatic-guide", 'Manually-guide'],default_index=1, 
        icons=['list-task', 'list-task'], menu_icon="cast")
